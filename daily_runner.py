...
def run_daily_analysis():
    ...
    for ticker, name in COINS.items():
        ...
        # 1. Fetch comprehensive data (fetch more data for ATH calculation)
        market_data = fetch_data(ticker) # Assuming fetch_data gets enough history for ATH
        ...
        # 5. Get the new 5-day 'High' forecast
        high_forecasts = prophet_forecast_highs(market_data.copy(), periods=5)
        ...
        result = {
            ...
            "High_Forecast_5_Day": json.dumps(high_forecasts)
        }
